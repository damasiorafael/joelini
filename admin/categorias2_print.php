...
require_once("include/categorias2_variables.php");
...
$page_layouts["categorias2_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "categorias2" );

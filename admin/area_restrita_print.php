...
require_once("include/area_restrita_variables.php");
...
$layout = new TLayout("print", "CoralOrange", "MobileOrange");
$layout->version = 2;
...
$page_layouts["area_restrita_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "area_restrita" );

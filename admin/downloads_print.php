...
require_once("include/downloads_variables.php");
...
$page_layouts["downloads_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "downloads" );

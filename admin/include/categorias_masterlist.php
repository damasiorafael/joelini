<?php
function DisplayMasterTableInfo_categorias($params)
{
	global $cman;
	...
	if($format == FORMAT_CHECKBOX)
		$class = ' rnr-field-checkbox';
	if($format == FORMAT_NUMBER || IsNumberType($settings->getFieldType("imagem")))
		$class = ' rnr-field-number';
	...
	$xt->displayPartial(GetTemplateName("categorias", "masterlist"));
}

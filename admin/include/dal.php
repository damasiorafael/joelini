...
class tDAL
{
	...
	var $tbljoelini_at_localhost__vendas;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "vendas", "varname" => "joelini_at_localhost__vendas", "altvarname" => "vendas", "connId" => "joelini_at_localhost", "schema" => "", "connName" => "joelini at localhost");
	}

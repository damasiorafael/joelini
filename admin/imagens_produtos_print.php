...
$layout = new TLayout("print", "CityAvenue", "MobileAvenue");
$layout->version = 2;
...
$page_layouts["imagens_produtos_print"] = $layout;
...
$layout = new TLayout("masterprint", "CityAvenue", "MobileAvenue");
$layout->version = 2;
...
$page_layouts["produtos_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "imagens_produtos" );

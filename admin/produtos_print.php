...
$page_layouts["produtos_print"] = $layout;
...
$page_layouts["subcategorias_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "produtos" );

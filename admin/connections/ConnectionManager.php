...
class ConnectionManager
{
	...
	{
		return $this->byId( "joelini_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "joelini_at_localhost";
		$data["connName"] = "joelini at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;joelini;;1"; //currently unused
		
		$this->_connectionsIdByName["joelini at localhost"] = "joelini_at_localhost";
...
;
		$connectionsData["joelini_at_localhost"] = $data;

...
require_once("include/categorias21_variables.php");
...
$page_layouts["categorias21_print"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "categorias21" );
